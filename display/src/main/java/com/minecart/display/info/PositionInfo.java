...
/**
 * 2D world-space position attached to a {@link com.minecart.logic.CircuitNode} so the display module
 * can render it. Persisted with the circuit so layout is preserved across save/load.
 */
