...
/**
 * Data for a full circuit snapshot (client resync). Wire format here; client-side apply lives in the client module.
 */
public final class CircuitSnapshotPayload implements Payload {

    public static final String PAYLOAD_ID = ProtocolStrings.PAYLOAD_CIRCUIT_SNAPSHOT;
    ...
    public void save(CompoundTag tag) {
        ...
        if (circuitData != null) {
            tag.put(ProtocolStrings.SNAPSHOT_TAG_CIRCUIT, circuitData.copy());
        }
    }
    ...
    public void load(CompoundTag tag) {
        ...
        Tag t = tag.get(ProtocolStrings.SNAPSHOT_TAG_CIRCUIT);
        circuitData = TagUtil.requireCompoundTag(t, "Missing or invalid '" + ProtocolStrings.SNAPSHOT_TAG_CIRCUIT + "'");
