...
public class DoubleTag extends Tag {
    ...
    @Override public void readData(DataInput input, SerializationContext context) throws IOException { this.data = input.readDouble(); }
    @Override public void writeData(DataOutput output, SerializationContext context) throws IOException { output.writeDouble(this.data); }
